...
// Source: github.com/RoyceAzure/go-stockinfo/worker (interfaces: TaskDistributor)

// Package mock_distributor is a generated GoMock package.
package mock_distributor
...
// DistributeTaskStockTransation mocks base method.
func (m *MockTaskDistributor) DistributeTaskStockTransation(arg0 context.Context, arg1 *worker.PayloadTransation, arg2 ...asynq.Option) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DistributeTaskStockTransation", varargs...)
	ret0, _ := ret[0].(error)
	return ret0
}

// DistributeTaskStockTransation indicates an expected call of DistributeTaskStockTransation.
func (mr *MockTaskDistributorMockRecorder) DistributeTaskStockTransation(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DistributeTaskStockTransation", reflect.TypeOf((*MockTaskDistributor)(nil).DistributeTaskStockTransation), varargs...)
}
