...
type schdulerCronWorker struct {
	service service.IDistributorService
	Cron    *gocron.Scheduler
}

func NewSchdulerWorker(service service.IDistributorService, loc *time.Location) *schdulerCronWorker {
...
func (cornWorker *schdulerCronWorker) SetUpSchdulerWorker(ctx context.Context) {
	...
	cornWorker.Cron.CronWithSeconds("*/6 * * * * *").Do(cornWorker.service.GetAllRegisStockAndSendToKa, ctx)
}
