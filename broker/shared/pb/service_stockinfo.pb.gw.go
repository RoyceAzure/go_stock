...
func RegisterStockInfoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StockInfoServer) error {
	...
	mux.Handle("GET", pattern_StockInfo_VerifyEmail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.StockInfo/VerifyEmail", runtime.WithHTTPPathPattern("/v1/email/verify"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterStockInfoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StockInfoClient) error {
	...
	mux.Handle("GET", pattern_StockInfo_VerifyEmail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.StockInfo/VerifyEmail", runtime.WithHTTPPathPattern("/v1/email/verify"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_StockInfo_VerifyEmail_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "email", "verify"}, ""))
